...
<html lang="es">
    ...
    <link href="css/RegistroProducto.css" rel="stylesheet">
        <title>RegistroPruductos</title>
    ...
    <body background="Img/Fondo.jpg">
        <div class="flex-center position-ref full-height">
                ...
                <section class="form-registro">
                    ...
                    <input class="control" type="int" name="codProducto" id="codProducto"  placeholder="Ingresar codigo">
                    <input class="control" type="text" name="nombre" id="nombre"  placeholder="Ingresar nombre producto">
